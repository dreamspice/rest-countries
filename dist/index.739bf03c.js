...
formEl.addEventListener("submit", function(e) {
    e.preventDefault();
    if (inputEl.value) getSearchedCountry(inputEl.value);
    else {
...
countriesEl.addEventListener("click", async function(e) {
    try {
        ...
        const res = await fetch(`https://restcountries.com/v3.1/name/${nameOfCountry}`);
        const [data] = await res.json();
  ...
  <div class="country__details">
    ...
    <p class="country__details--native-name">Native Name:<span class="country__details--data">${state.currentCountry.name}</span></p>
    <p class="country__details--population">Population:<span class="country__details--data">${state.currentCountry.population}</span></p>
    <p class="country__details--region">Region:<span class="country__details--data">${state.currentCountry.region}</span></p>
    <p class="country__details--subregion">Sub Region:<span class="country__details--data">${state.currentCountry.subregion}</span></p>
    <p class="country__details--capital">Capital:<span class="country__details--data">${state.currentCountry.capital}</span></p>

    <p class="country__details--domain">Top Level Domain:<span class="country__details--data">${state.currentCountry.domain}</span></p>

    <p class="country__details--borders">Border Countries:<span class="country__details--data">${state.currentCountry.borders ? state.currentCountry.borders.join(", ") : "None"}</span></p>
  </div>
</div>`;
...
if (theme === "dark") buttonTheme.textContent = "☀️ Light mode";
else buttonTheme.textContent = "\uD83C\uDF1A Dark mode";
...
},{"./../sass/main.scss":"dFl68"}],"dFl68":[function() {},{}]},["cVgJb","ebWYT"], "ebWYT", "parcelRequire1861")
